...
encoder sees a similar silhouette to the SMPL-H baseline (strategy α). This
variant keeps the mesh-free 2683b67 visual strategy, but adds bridge capsules
so legs connect to the pelvis and arms connect to the shoulders.

...
$24.95\,\%$ are labelled unsafe ($r^{\mathrm{safe}} = 0$) at the
...
AMASS~\cite{mahmood2019amass} (CMU subset, downloaded 18 February 2026).
Hardware: single NVIDIA A100 40\,GB, CUDA 12.8, PyTorch
2.10.0. Step-by-step recipe for reproducing the headline
...
\texttt{noisy}; 37{,}883 transitions, \placeholder{$\sim$Z\,GB}
compressed). \bigym{}
